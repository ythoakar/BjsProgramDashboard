    ...
    <div className="dashboard-container">
      ...
      <div className="col col-1">
        <div className="col-1-child child-50">
          {allUserData && <SEC_Div data={allUserData} heading="National Executive Committee" />}
        ...
        <div className="col-1-child child-50">
          {allUserData && <SEC_Div data={allUserData}  heading="State Executive Committee" />}
        ...
        <div className="col-1-child child-50">
          {allUserData && <SEC_Div data={allUserData}  heading="Region Executive Committee" />}
      
        </div>

        <div className="col-1-child child-50">
          {allUserData && <SEC_Div data={allUserData}  heading="District Executive Committee"/>}
...
<div className="col col-3">
    ...
    <div className="col-3-child child-50">
        <h3>Water Team</h3>  
        {allUserData && <CommitteeCard data={allUserData} heading="District Executive Committee" />    }
    </div>
